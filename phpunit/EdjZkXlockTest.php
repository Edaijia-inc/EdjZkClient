...
class EdjZkXlockTest extends PHPUnit_Framework_TestCase
{
	protected $zl;
	const BASE_PATH="/EdjZklock_test";
	const CLN="common_lock_name";

	protected function setUp()
	{
		$this->zl=new EdjZkXlock(self::BASE_PATH);
	}
	...
	{
		return new EdjZkXlock(self::BASE_PATH, NULL, true);
	}

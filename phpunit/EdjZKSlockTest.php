...
class EdjZkSlockTest extends PHPUnit_Framework_TestCase
{
	protected $zl;
	const BASE_PATH="/EdjZkslock_test";
	const CLN="common_lock_name";

	protected function setUp()
	{
		$this->zl=new EdjZkSlock(self::BASE_PATH);
	}
	...
	{
		return new EdjZkSlock(self::BASE_PATH, NULL, true);
	}
